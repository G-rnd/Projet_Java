...
*/
        ...
        */
        ...
        //Trier des dates
        int[]date1={25,12,2020};
        int[]date2={14,02,2021};
        int[]date3={31,10,2020};

        ArrayList<int[]> listeDateDerniereVisite=new ArrayList<>(Arrays.asList(date1,date2,date3));
        System.out.println(listeDateDerniereVisite);
        a.TrieDateDerniereVisite(listeDateDerniereVisite);
        System.out.println(listeDateDerniereVisite);
